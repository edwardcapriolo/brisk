...
public class BriskErrorDaemon extends org.apache.cassandra.service.AbstractCassandraDaemon
{

    private static Logger logger = LoggerFactory.getLogger(BriskErrorDaemon.class);
    ...
    private static class ThriftServer extends Thread
    {
        ...
        public ThriftServer(InetAddress listenAddr, int listenPort)
        {
            ...
            final BriskErrorServer briskServer = new BriskErrorServer();
